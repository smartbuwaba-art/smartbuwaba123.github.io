SMART BUWABA APP V12 — CREATOR EDITION

New:
- Creator profile with Likes, Following, Followers and Videos.
...
MEDIA UPLOAD WITHOUT FIREBASE BLAZE:
1. Create a Cloudinary account.
2. Create an unsigned upload preset.
3. In Smart Buwaba Settings -> Media Upload, enter Cloud name and unsigned upload preset.
4. Save.
